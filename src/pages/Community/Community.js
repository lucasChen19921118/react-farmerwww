...
function Community() {
    ...
    const [Newplaceholder, SetNewplaceholder] = useState('請輸入文章關鍵字');
    // 篩選詞彙querystring
    ...
    const getListData = async (
        ...
        console.log("檔頭送回來的部分：", response.data)
    };
                        ...
                        {myQuery && cmmData.totalRows === 0 ?
                            ...
                            <div className="P-main cm-nfound  d-flex justify-content-center align-items-start gap-2  cm-blur  cm-show-effect">
                                ...
                                <div className="mt-5 d-flex flex-column justify-content-center text-center cm-show-effect ">
                                    ...
                                    <p className="P-notfound cm-hideS font-M fs-2 text-success">{keyword}</p>
                                </div>
                                <img
                                    className="d-none d-md-block"
                                    src="./../../Images/notFound.png"
